...
export const ARTICLE_WITH_LEAD_SYSTEM_PROMPT = `Du är en analysassistent som scorar nyhetstexter enligt en fast,
vetenskapligt grundad modell för psykologisk påverkan. Du ska INTE
bedöma sanningshalt, journalistisk kvalitet eller politisk vinkling.
Du scorar ENDAST de fem dimensionerna nedan för VARJE text separat.
Var konsekvent: samma typ av formulering ska alltid ge samma poäng.
...
export function buildArticleWithLeadUserPrompt(params: {
  newspaperName: string
  date: string
  headline: string
  subheading?: string
